...
(function (e, t) {
				...
				CHILD: function (e, t, n, r, i) {
					...
					return 1 === r && 0 === i ? function (e) {
						...
						if (m) {
							...
							else while (p = ++d && p && p[g] || (f = d = 0) || h.pop()) if ((s ? p.nodeName.toLowerCase() === y : 1 === p.nodeType) && ++f && (v && ((p[b] || (p[b] = {}))[e] = [T, f]), p === t)) break; return f -= i, f === r || 0 === f % r && f / r >= 0
						}
					}
				},
				PSEUDO: function (e, t) {
	...
	x.ajaxSetup({
		...
		var o, a, s, l = n.jsonp !== !1 && (Bn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded; charset=UTF-8") && Bn.test(n.data) && "data");
...
>>>>>>> 0897636c691fca769348926098d6a74000148545
