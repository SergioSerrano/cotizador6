/*! jQuery Mobile 1.4.1pre | Git HEAD hash: dfc5d32 <> 2014-01-11T00:07:15Z | (c) 2010, 2014 jQuery Foundation, Inc. | jquery.org/license */
	...
	function (a, b) {
		...
		a.widget("mobile.selectmenu", a.mobile.selectmenu, {
			...
			build: function () {
				...
				}), o = a("<ul class='ui-selectmenu-list' id='" + i + "' role='listbox' aria-labelledby='" + this.buttonId + "'" + j + l + "></ul>").appendTo(n), p = a("<div class='ui-header ui-bar-" + (v.theme ? v.theme : "inherit") + "'></div>").prependTo(n), q = a("<h1 class='ui-title'></h1>").appendTo(p), this.isMultiple && (t = a("<a>", {
					role: "button",
					text: v.closeText,
					href: "#",
